...
letting it move \emph{with the treatment}? Put concretely, it is a question about the
\emph{detection algorithm} itself: can BRIM (or any community-detection method) be made to
deliver a partition that updates with the data yet stays, by construction, blind to the
shock? Any intuition you have on that --- even that I am framing it wrongly --- would help.
