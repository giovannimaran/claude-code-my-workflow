...
degree-sequence artefacts, and we implement it throughout. Additional firm-level
Economic Fitness and Complexity (EFC) evidence---the firm-level application of the FC
algorithm to firm--product data---from \citet{bontadini2021, bontadini2025} on multi-layer capability networks,
...
most exposed Chinese firms). The working
hypothesis for the $d_{\rm out}$ response is therefore $\approx$0.3--0.7 percent per
standard-deviation increase in TariffShock on average, rising to 1.0--1.6 percent for
top-quartile ExpDep firms; estimates outside this band should trigger a
...
\hline
Working hypothesis --- top-quartile ExpDep & $1.0$--$1.6\%$ & Approaches the targeted-shock upper bound. \\
\hline
\end{tabular}
\end{table}
